...
<section class="py-5" id="counter-section"
    ...
    <div class="container">
        ...
        <div class="row text-center g-4">
            ...
            <div class="col-6 col-md-3 position-relative py-4">
                ...
                <h1 class="display-4 fw-bold counter-wrap" style="font-family: serif;">
                    <span class="counter-num"
                        data-target="{{ preg_replace('/[^0-9]/', '', $counter->value_1 ?? '0') }}"
                        data-suffix="{{ trim(preg_replace('/[0-9]/', '', $counter->value_1 ?? ''), '+ ') }}+">0</span>
                </h1>
            ...
            <div class="col-6 col-md-3 position-relative py-4">
                ...
                <h1 class="display-4 fw-bold counter-wrap" style="font-family: serif;">
                    <span class="counter-num"
                        data-target="{{ preg_replace('/[^0-9]/', '', $counter->value_2 ?? '0') }}"
                        data-suffix="{{ trim(preg_replace('/[0-9]/', '', $counter->value_2 ?? ''), '+ ') }}+">0</span>
                </h1>
            ...
            <div class="col-6 col-md-3 position-relative py-4">
                ...
                <h1 class="display-4 fw-bold counter-wrap" style="font-family: serif;">
                    <span class="counter-num"
                        data-target="{{ preg_replace('/[^0-9]/', '', $counter->value_3 ?? '0') }}"
                        data-suffix="{{ trim(preg_replace('/[0-9]/', '', $counter->value_3 ?? ''), '+ ') }}+">0</span>
                </h1>
            ...
            <div class="col-6 col-md-3 position-relative py-4">
                ...
                <h1 class="display-4 fw-bold counter-wrap" style="font-family: serif;">
                    <span class="counter-num"
                        data-target="{{ preg_replace('/[^0-9]/', '', $counter->value_4 ?? '0') }}"
                        data-suffix="{{ trim(preg_replace('/[0-9]/', '', $counter->value_4 ?? ''), '+ ') }}+">0</span>
                </h1>
...
<script>
    (function() {
        /**
         * Count-up animation — fires once when #counter-section enters the viewport.
         * Each .counter-num element reads:
         *   data-target  = the numeric end value (e.g. 500)
         *   data-suffix  = the text appended after the number (e.g. "+" or "k+")
         * Duration: 2 seconds, eased with easeOutQuart.
         */
        const section = document.getElementById('counter-section');
        const counters = section ? section.querySelectorAll('.counter-num') : [];
        let animated = false;
