                ...
                <div class="card-body">
                    <form action="{{route('update.services')}}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="ckeditor form-control" col="10" row="3" name="service_details_small">{!! $service->service_details_small !!}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea  class="ckeditor form-control" col="10" row="3" name="service_details1">{!! $service->service_details1 !!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Service Long Details two</label>
                            <textarea  class="ckeditor form-control" col="10" row="3" name="service_details2">{!! $service->service_details2 !!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Service Long Details three</label>
                            <textarea  class="ckeditor form-control" col="10" row="3" name="service_details3">{!! $service->service_details3 !!}</textarea>
                        </div>
